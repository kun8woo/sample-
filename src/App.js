  ...
  '2025-03-22': [
    {
      ...
      court: '서울중앙지법 1호',
      judge: '김민수 부장판사',
      overview: '2024년 서울에서 발생한 OO초등생 관련 사건으로, 피고인은 피해자를 유인해 살해한 후 유기한 혐의로 기소되었습니다.',
      timeline: [
    ...
    },
    {
      ...
      court: '서울중앙지법 3호',
      judge: '김민수 부장판사',
      overview: '오후 공판에서는 추가 증인 신문과 검찰 측 증거 서류 제출이 예정되어 있습니다.',
      timeline: [
        '1차 공판 - 2025-01-15 (피고인 혐의 인정 여부)',
        '2차 공판 - 2025-02-18 (증인 신문 진행)',
    ...
    },
    {
      ...
      court: '서울중앙지법 5호',
      judge: '김민수 부장판사',
      overview: '마지막으로 선고가 예정되어 있습니다. 검찰은 무기징역을 구형할 것으로 보입니다.',
      timeline: ['1차 공판 - 2025-01-15', '2차 공판 - 2025-02-18', '선고 - 2025-03-22 (형량 결정)'],
      relatedNews: [
        {
          name: 'SBS 단독 보도 - ‘OO초등생 사건’ 피고인 법정에서 울먹여',
          url: 'https://news.sbs.co.kr/',
  ...
  '2025-04-02': [
    {
      ...
      court: '서울중앙지법 2호',
      judge: '박영희 판사',
      overview: '피고인은 사기 혐의로 기소되었으며, 증인 2명이 출석할 예정입니다.',
      timeline: ['1차 공판 - 2025-03-05', '2차 공판 - 2025-03-20', '3차 공판 예정 - 2025-04-02'],
      relatedNews: [
        {
  ...
  '2025-04-10': [
    {
      ...
      court: '서울중앙지법 6호',
      judge: '이철수 부장판사',
      overview: '1심에서 징역 2년이 선고된 YY 사건이 항소심을 맞이했습니다. 양측 변호인단이 치열한 공방을 벌일 것으로 예상됩니다.',
      timeline: ['1심 판결 - 2025-02-10 (징역 2년 선고)', '항소심 1차 공판 - 2025-04-10 (변론 및 증거 제출)'],
      relatedNews: [],
    },
    {
      id: 6,
      ...
      court: '서울중앙지법 7호',
      judge: '이철수 부장판사',
      overview: '오후에 추가 증인 신문이 예정되어 있습니다. 변호인 측에서 새 증거를 제출할 가능성이 있습니다.',
      timeline: ['1심 판결 - 2025-02-10', '항소심 1차 공판 - 2025-04-10 (오후 증인 신문)'],
      relatedNews: [],
    },
  ],
};
...
function HeaderBar({ setScreen }) {
  return (
    <div className="flex justify-end bg-white px-4 py-2 border-b border-gray-300">
      <button className="text-gray-600 mx-2 hover:text-black" onClick={() => setScreen('login')}>
        <LogIn className="w-5 h-5" />
      </button>
      <button className="text-gray-600 mx-2 hover:text-black" onClick={() => setScreen('logout')}>
        <LogOut className="w-5 h-5" />
      </button>
      <button className="text-gray-600 mx-2 hover:text-black" onClick={() => setScreen('mypage')}>
        <User className="w-5 h-5" />
      </button>
      <button className="text-gray-600 mx-2 hover:text-black" onClick={() => setScreen('settings')}>
    ...
    <div className="p-4 space-y-6">
      <div className="flex flex-col items-center mt-4 space-y-4">
        <div className="flex items-center justify-center space-x-2">
          ...
          <motion.h1 initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-2xl font-bold text-[#001F3F]">
            Legal Insights
          </motion.h1>
        </div>
        <div className="w-full flex items-center space-x-2">
          ...
          />
          <Button className="rounded-lg px-4 py-2 bg-[#001F3F] text-white hover:bg-gray-500" onClick={onSearch}>
            검색
          </Button>
        </div>
      </div>
      ...
      <Card className="rounded-2xl shadow p-4 bg-[#FAFAFA]">
        <CardContent>
          <h2 className="text-xl font-semibold text-black">서울중앙지법, OO 사건 판결 발표</h2>
          <p className="text-sm text-gray-600 mt-1">2025-03-21 / 법률 뉴스</p>
          <p className="text-sm text-gray-800 mt-2">
            최근 서울중앙지법에서 발표된 OO 사건 판결 소식입니다. 이번 판결은 법률 전문가들 사이에서 큰 주목을 받고 있습니다.
          </p>
          <Button className="rounded-2xl mt-4 w-full bg-[#001F3F] text-white hover:bg-gray-500" onClick={onDetail}>
            상세보기
          </Button>
        </CardContent>
      </Card>
        ...
        <CardContent>
          ...
          <Calendar
            ...
            tileContent={({ date: d }) => {
              ...
              return caseDates[dateStr] ? <div className="text-xs font-semibold text-[#800020] mt-1">{caseDates[dateStr]}건</div> : null;
            }}
            ...
            tileClassName={({ date: d, view }) => {
              if (view === 'month') {
                return d.getMonth() === activeStartDate.getMonth() ? 'text-black' : 'text-gray-400';
              }
              return 'text-black';
            }}
          />
    ...
    <div className="p-4 space-y-6">
      ...
      <Card className="rounded-2xl shadow p-4 bg-[#FAFAFA]">
        <CardContent>
          ...
          <p className="text-sm text-gray-600 mt-2">AI가 자동으로 최신 판례를 요약하였습니다. [여기에 요약 내용이 표시됩니다.]</p>
        </CardContent>
      </Card>
      ...
      <Card className="rounded-2xl shadow p-4 bg-[#FAFAFA]">
        <CardContent>
          ...
          <p className="text-sm text-gray-600 mt-2">입력하신 키워드에 따른 관련 판례와 법 조항을 아래에 보여드립니다.</p>
          <ul className="list-disc ml-5 mt-2">
      ...
      <p className="text-xs text-gray-500">차별점: 한국 법률 정보를 쉽게 접근할 수 있도록 돕는 맞춤형 AI 법률 도우미</p>
    </div>
  );
}
...
function ReservationScreen({ onBack }) {
  ...
  return (
    <div className="p-4 space-y-6">
      <div className="flex items-center space-x-2 cursor-pointer" onClick={onBack}>
        <ChevronLeft className="w-5 h-5 text-[#001F3F]" />
        <h1 className="text-xl font-bold text-[#001F3F]">실시간 방청 & 예약 시스템</h1>
      </div>

      <Card className="rounded-2xl shadow p-4 bg-[#FAFAFA]">
        <CardContent>
          <h2 className="text-lg font-semibold text-black">방청 가능한 사건 리스트</h2>
          <p className="text-sm text-gray-600 mt-2">아래 사건들은 현재 방청 예약이 가능합니다.</p>
          <ul className="mt-4 space-y-2">
            {availableEvents.map((event) => (
              <li key={event.id} className="border p-2 rounded-lg bg-white">
                ...
                <div className="mt-1 text-sm text-gray-600">{event.idRequired ? '신분증 필요' : '신분증 필요 없음'}</div>
                <Button className="mt-2 w-full rounded-2xl bg-[#001F3F] text-white hover:bg-gray-500" disabled={event.availableSeats === 0}>
      ...
      <p className="text-xs text-gray-500">
        차별점: 현재 한국에는 방청 정보를 실시간으로 제공하는 플랫폼이 없으며, 방청석 사전 예약 기능을 통해 법원 방문자들에게 유용한 정보를
        제공합니다.
      </p>
    </div>
  );
...
function DiscussionScreen({ onBack }) {
  const discussions = [
    {
      ...
      caseTitle: 'OO 사건 판결',
      author: '홍길동',
      content: '이 판결이 정말 합당한가요? 피해자가 너무 억울해 보이는데, 여러분의 의견이 궁금합니다.',
      upvotes: 20,
      downvotes: 5,
    },
    {
      ...
      author: '김철수',
      content: '무죄 판결에 대해 시민과 전문가 의견이 많이 갈리고 있습니다. 투표로 의견 남겨주세요!',
      upvotes: 12,
      downvotes: 3,
    },
  ];
  ...
  return (
    <div className="p-4 space-y-6">
      <div className="flex items-center space-x-2 cursor-pointer" onClick={onBack}>
        <ChevronLeft className="w-5 h-5 text-[#001F3F]" />
        <h1 className="text-xl font-bold text-[#001F3F]">법률 토론 & 집단 청원</h1>
      </div>
      <Card className="rounded-2xl shadow p-4 bg-[#FAFAFA]">
        <CardContent>
          <h2 className="text-lg font-semibold text-black">AI 여론 분석</h2>
          <p className="text-sm text-gray-600 mt-2">현재 토론 중인 판결들에 대한 AI 분석 결과입니다.</p>
          <ul className="list-disc ml-5 mt-2 text-sm text-gray-700">
            <li>OO 사건: 찬성 65%, 반대 35%</li>
            <li>XX 사건: 찬성 40%, 반대 60%</li>
          </ul>
          <p className="text-xs text-gray-500 mt-2">(여론 추이는 실시간으로 업데이트됩니다.)</p>
        </CardContent>
      </Card>
      // ========== [Part 1 끝] ========== // ========== [Part 2 시작] ==========
      <Card className="rounded-2xl shadow p-4 bg-[#FAFAFA]">
        <CardContent>
          ...
          <p className="text-sm text-gray-600 mt-2">
            특정 사건에 대한 제도 개선이나 법률 개정을 원하시면 국민동의청원 페이지를 통해 의견을 제출할 수 있습니다.
          </p>
          <Button
          ...
          <CardContent>
            ...
            <div className="flex items-center justify-between mt-4">
              <div className="flex space-x-4">
                <Button className="px-2 py-1 rounded bg-blue-500 text-white text-sm">찬성 {disc.upvotes}</Button>
                <Button className="px-2 py-1 rounded bg-gray-500 text-white text-sm">반대 {disc.downvotes}</Button>
              </div>
              <Button className="px-2 py-1 rounded bg-[#001F3F] text-white text-sm hover:bg-gray-500">댓글 달기</Button>
            </div>
          </CardContent>
        </Card>
      ))}
      <div className="p-4 border rounded-lg bg-white">
        ...
        <textarea className="w-full p-2 border border-gray-300 rounded-lg" placeholder="논의하고 싶은 판결이나 사건을 적어주세요." />
        <Button className="mt-2 w-full rounded-2xl bg-[#001F3F] text-white hover:bg-gray-500">토론 주제 등록</Button>
      </div>
      <p className="text-xs text-gray-500">
        차별점: 재판이 끝나도 해당 판결에 대한 토론이 계속 진행될 수 있으며, 사용자들의 의견이 법 개정이나 제도 변화에 영향을 줄 수 있습니다.
      </p>
    </div>
  );
}
...
function ConsultationScreen({ onBack }) {
  ...
  const filteredAttorneys = attorneys.filter((attorney) => attorney.specialty.includes(attorneyQuery) || attorney.name.includes(attorneyQuery));
    ...
    <div className="p-4 space-y-6">
      ...
      <Card className="rounded-2xl shadow p-4 bg-[#FAFAFA]">
        <CardContent>
          ...
          <p className="text-sm text-gray-600 mt-2">안녕하세요, 법률 상담 AI입니다. 궁금하신 법률 문제를 입력해주세요.</p>
          <div className="mt-4">
            <textarea className="w-full p-2 border border-gray-300 rounded-lg" placeholder="예: 계약서 관련 문의..." />
            <Button className="mt-2 w-full rounded-2xl bg-[#001F3F] text-white hover:bg-gray-500">상담 요청</Button>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="rounded-2xl shadow p-4 bg-[#FAFAFA]">
        <CardContent>
          ...
          <p className="text-sm text-gray-600 mt-2">법률구조공단 및 공익 변호사단체와 연계하여 무료 상담이 가능합니다.</p>
          <Button className="mt-2 w-full rounded-2xl bg-[#001F3F] text-white hover:bg-gray-500">무료 상담 연결</Button>
        </CardContent>
      </Card>
      ...
      <Card className="rounded-2xl shadow p-4 bg-[#FAFAFA]">
        <CardContent>
          ...
          <p className="text-sm text-gray-600 mt-2">사건 키워드를 입력하면 해당 분야에 경험이 많은 변호사들을 보여드립니다.</p>
          <div className="mt-2 flex space-x-2">
            ...
            />
            <Button className="rounded-lg bg-[#001F3F] text-white hover:bg-gray-500">검색</Button>
          </div>
        </CardContent>
      </Card>
        ...
        <Card key={attorney.id} className="rounded-2xl shadow p-4 bg-white">
          <CardContent>
            <div className="flex justify-between items-center">
              ...
              <Button className="px-2 py-1 rounded bg-[#001F3F] text-white text-sm hover:bg-gray-500">채팅하기</Button>
            </div>
          </CardContent>
        </Card>
      ))}
      ...
      <p className="text-xs text-gray-500">
        차별점: AI 기반 법률 상담과 무료 변호사 매칭 기능뿐만 아니라, 일반 변호사 검색을 통해 특정 사건 경험이 많은 변호사를 직접 채팅으로 컨택할 수
        있습니다.
      </p>
    </div>
  );
          ...
          <div className="border-t border-gray-200 mt-4 pt-4 space-y-4">
            <div>
              ...
              <p className="text-sm text-gray-700 mt-1">
                2024년 서울에서 발생한 OO초등생 살해 사건으로, 피고인은 피해자를 유인해 살해한 후 유기한 혐의로 기소되었습니다. 전국민적 공분을
                샀으며, 현재 3차 공판을 앞두고 있습니다.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="text-sm text-blue-600 list-disc ml-5 mt-1">
                <li>
                  <a href="https://news.sbs.co.kr/news/endPage.do?news_id=N1007854306">SBS 단독 보도 - ‘OO초등생 사건’ 피고인 법정에서 울먹여</a>
                </li>
                <li>
                  <a href="https://news.jtbc.co.kr/article/NB11715173?code=issue&idx=NK10000606">JTBC - 피해자 부모 측 ‘엄벌 요구’</a>
                </li>
              </ul>
            </div>
          </div>
    ...
    <div className="p-4 space-y-6">
      ...
      <Card className="rounded-lg shadow p-4 bg-[#FAFAFA] border border-gray-300 text-center">
        <CardContent>
          ...
          <p className="text-sm text-gray-800 mt-2">
            법률 서비스 지원과 공익 향상을 위한 자선사업에 함께해 주세요. 기부를 통해 사회 정의 구현에 동참할 수 있습니다.
          </p>
          <Button className="rounded-2xl mt-4 w-full bg-[#001F3F] text-white hover:bg-gray-500">피해자 지원을 위해 기부하실 수 있습니다.</Button>
          <p className="text-xs text-gray-600 mt-4">본 서비스는 법무부 산하 공익단체와 연결되어 있습니다.</p>
        </CardContent>
      </Card>
    </div>
  );
...
// (9) CalendarScreen
function CalendarScreen({ date, setDate, caseDates, activeStartDate, setActiveStartDate, onDateClick }) {
  return (
    <div className="p-4 space-y-6">
      <Card className="rounded-lg shadow p-4 bg-[#FAFAFA] border border-gray-300 text-center">
        <CardContent>
      ...
      {newsItems.map((item) => (
        <Card key={item.id} className="rounded-2xl shadow p-4 bg-[#FAFAFA]">
          <CardContent className="flex items-center">
            <img src={item.image} alt="news" className="w-16 h-16 object-cover rounded mr-4" />
        ...
        caseList.map((courtCase) => (
          <Card key={courtCase.id} className="rounded-2xl shadow p-4 bg-[#FAFAFA]">
            <CardContent>
              ...
              <Button className="mt-2 w-full rounded-2xl bg-[#001F3F] text-white hover:bg-gray-500" onClick={() => onCaseSelect(courtCase.id)}>
                상세보기
              </Button>
            </CardContent>
          </Card>
    ...
    <div className="p-4 space-y-6">
      ...
      <Card className="rounded-2xl shadow p-4 bg-[#FAFAFA]">
        <CardContent>
          ...
          <p className="text-sm text-gray-700 mt-2 font-semibold">담당 판사: {foundCase.judge}</p>
          <div className="border-t border-gray-200 mt-4 pt-4 space-y-4">
            <div>
              <h3 className="font-semibold text-gray-800">사건 개요</h3>
    ...
    <div className="p-4 space-y-6">
      ...
      <Card className="rounded-2xl shadow p-4 bg-[#FAFAFA]">
        <CardContent>
          ...
          <p className="text-sm text-gray-600 mt-2">예: “계약 위반”, “상속 분쟁”, “교통사고 형사” 등</p>
          <div className="mt-2 flex space-x-2">
            <input
              type="text"
              className="w-full p-2 border border-gray-300 rounded-lg"
            ...
            />
            <Button className="rounded-lg bg-[#001F3F] text-white hover:bg-gray-500" onClick={handlePredict}>
              예측하기
            </Button>
          </div>
        </CardContent>
        ...
        <Card className="rounded-2xl shadow p-4 bg-[#FAFAFA]">
          <CardContent>
            ...
            <p className="text-xs text-gray-500 mt-2">
              * 판례 출처:{' '}
              <a href="https://portal.scourt.go.kr/pgp/index.on" target="_blank" rel="noreferrer" className="underline text-blue-600">
                대법원 종합법률포털
              </a>
            </p>
          </CardContent>
      ...
      <p className="text-xs text-gray-500">
        차별점: 현재 어떤 법률 앱도 판결 예측을 제공하지 않으며, 변호사 없이도 사건의 대략적인 결과를 예측할 수 있어 일반 사용자들에게 유용합니다.
      </p>
    </div>
  );
}
    ...
    <div className="p-4 space-y-6">
      ...
      <Card className="rounded-2xl shadow p-4 bg-[#FAFAFA]">
        <CardContent>
          ...
          <p className="text-sm text-gray-600 mt-2">아래 소셜 계정을 이용해 간편하게 로그인할 수 있습니다.</p>
          <div className="mt-4 flex flex-col space-y-2">
            <Button className="rounded-lg bg-yellow-400 text-black hover:bg-yellow-300">카카오톡 로그인</Button>
            <Button className="rounded-lg bg-green-500 text-white hover:bg-green-400">네이버 로그인</Button>
            <Button className="rounded-lg bg-red-500 text-white hover:bg-red-400">구글 로그인</Button>
            <Button className="rounded-lg bg-black text-white hover:bg-gray-700">애플 로그인</Button>
          </div>
        </CardContent>
      </Card>
    </div>
    ...
    <div className="p-4 space-y-6">
      ...
      <Card className="rounded-2xl shadow p-4 bg-[#FAFAFA]">
        <CardContent>
          ...
          <p className="text-sm text-gray-600 mt-2">로그아웃을 진행하시겠습니까?</p>
          <Button className="mt-4 w-full rounded-lg bg-[#001F3F] text-white hover:bg-gray-500">로그아웃하기</Button>
        </CardContent>
      </Card>
    </div>
  );
    ...
    <div className="p-4 space-y-6">
      ...
      <Card className="rounded-2xl shadow p-4 bg-[#FAFAFA]">
        <CardContent>
          ...
          <p className="text-sm text-gray-600 mt-2">[사용자 이름], [가입일], [이메일], [등급] 등 사용자 정보를 표시할 수 있습니다.</p>
          <Button className="mt-4 w-full rounded-lg bg-[#001F3F] text-white hover:bg-gray-500">정보 수정</Button>
        </CardContent>
      </Card>
    </div>
  );
    ...
    <div className="p-4 space-y-6">
      ...
      <Card className="rounded-2xl shadow p-4 bg-[#FAFAFA]">
        <CardContent>
          ...
          <p className="text-sm text-gray-600 mt-2">알림, 테마, 언어 설정 등 다양한 옵션을 설정할 수 있습니다.</p>
          <Button className="mt-4 w-full rounded-lg bg-[#001F3F] text-white hover:bg-gray-500">설정 저장</Button>
        </CardContent>
      </Card>
    </div>
  );
...
function NavItem({ icon, label, active, onClick }) {
  return (
    <button onClick={onClick} className={`flex flex-col items-center ${active ? 'text-[#001F3F]' : 'text-gray-500'}`}>
      {icon}
...
function BottomNavigation({ currentTab, setCurrentTab }) {
  return (
    <div className="flex justify-around border-t border-gray-300 bg-white py-2">
      <NavItem icon={<Home className="w-6 h-6" />} label="홈" active={currentTab === 'home'} onClick={() => setCurrentTab('home')} />
      <NavItem icon={<FileText className="w-6 h-6" />} label="뉴스" active={currentTab === 'news'} onClick={() => setCurrentTab('news')} />
      <NavItem icon={<DollarSign className="w-6 h-6" />} label="기부" active={currentTab === 'donation'} onClick={() => setCurrentTab('donation')} />
      <NavItem
...
function LegalInsightsApp() {
  ...
  const renderScreen = () => {
    switch (screen) {
      ...
      case 'ai':
        return <AICaseSummaryScreen onBack={() => setScreen('home')} searchQuery={searchQuery} />;
      case 'reservation':
      ...
      case 'caseDetail':
        return <CaseDetailScreen onBack={() => setScreen('caseList')} dateStr={selectedDate} caseId={selectedCaseId} casesData={casesData} />;
      case 'prediction':
